    ...
    <Card>
      ...
      <CardContent>
        {draftEvents.length === 0 && approvedEvents.length === 0 ? (
          <div className="rounded-lg border border-dashed border-cyan-200 bg-cyan-50 p-4 text-sm text-cyan-900">
            Tidak ada kegiatan yang menunggu persetujuan atau publikasi. Draft dari ASN Tier 1 akan muncul di sini.
          </div>
        ) : (
          <div className="space-y-4">
            {draftEvents.length > 0 && (
